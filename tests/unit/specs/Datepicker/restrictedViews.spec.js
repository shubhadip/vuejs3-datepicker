...
describe('Datepicker with restricted views', () => {
  ...
  it('should not render unused views', async () => {
    ...
    expect(wrapper.vm.$el.querySelectorAll('.vuejs3-datepicker__calendar').length).toEqual(1)
    expect(wrapper.vm.$el.querySelectorAll('.vuejs3-datepicker__calendar .cell.month').length).toEqual(0)
    expect(wrapper.vm.$el.querySelectorAll('.vuejs3-datepicker__calendar .cell.year').length).toEqual(0)
    ...
    wrapper.vm.showCalendar()
    expect(wrapper.vm.$el.querySelectorAll('.vuejs3-datepicker__calendar').length).toEqual(2)
    expect(wrapper.vm.$el.querySelectorAll('.vuejs3-datepicker__calendar .cell.day').length).toEqual(0)
    expect(wrapper.vm.$el.querySelectorAll('.vuejs3-datepicker__calendar .cell.year').length).toBeGreaterThan(0)
  })
})
