  ...
  return withDirectives((openBlock(), createBlock("div", {
    ...
    (_ctx.allowedToShowView('day'))
      ? (openBlock(), createBlock(_component_picker_day, {
          ...
          _: 1
        }, 8 /* PROPS */, ["pageDate", "selectedDate", "showDayView", "fullMonthName", "allowedToShowView", "disabledDates", "highlighted", "calendarClass", "calendarStyle", "translation", "pageTimestamp", "isRtl", "mondayFirst", "dayCellContent", "onChangedMonth", "onSelectDate", "onShowMonthCalendar", "onSelectedDisabled", "onShowYearCalendar", "minimumView", "maximumView"]))
      : createCommentVNode("v-if", true),
...
const _hoisted_3$4 = /*#__PURE__*/createVNode("label", null, "Typeable", -1 /* HOISTED */);
const _hoisted_4$2 = { class: "wrapper" };
