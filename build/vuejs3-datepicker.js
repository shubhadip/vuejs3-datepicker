...
import { defineComponent as q, openBlock as g, createElementBlock as b, normalizeClass as S, createElementVNode as N, ref as U, computed as y, watch as Z, resolveComponent as _, createTextVNode as Ce, toDisplayString as v, createCommentVNode as $, createVNode as fe, renderSlot as Y, withDirectives as le, normalizeStyle as ye, withModifiers as ae, Fragment as x, renderList as ee, vShow as ge, resolveDirective as Me, withCtx as W, createBlock as me } from "vue";
...
const je = /* @__PURE__ */ G(Fe, [["render", Ye]]), f = (e, t = !1) => t ? e.getUTCFullYear() : e.getFullYear(), p = (e, t = !1) => t ? e.getUTCMonth() : e.getMonth(), I = (e, t = !1) => t ? e.getUTCDate() : e.getDate(), z = (e, t = !1) => t ? e.getUTCDay() : e.getDay(), he = (e, t, s = !1) => s ? e.setUTCFullYear(t) : e.setFullYear(t), pe = (e, t, s = !1) => s ? e.setUTCMonth(t) : e.setMonth(t), re = (e, t, s = !1) => s ? e.setUTCDate(t) : e.setDate(t), oe = (e, t, s = !1) => {
  ...
  if (typeof e == "number")
    return t[e];
  throw TypeError("Invalid type");
}, Ie = (e, t) => /8|3|5|10/.test(t) ? 30 : t === 1 ? !(e % 4) && e % 100 || !(e % 400) ? 29 : 28 : 31, Je = (e) => {
  switch (e) {
    case 1:
    case 21:
    case 31:
  ...
  const o = f(e), l = p(e) + 1, m = I(e);
  return t.replace(/dd/, `0${m}`.slice(-2)).replace(/d/, m).replace(/yyyy/, o).replace(/yy/, String(o).slice(2)).replace(/MMMM/, ne(p(e), s.months)).replace(/MMM/, ue(p(e), s.monthsAbbr)).replace(/MM/, `0${l}`.slice(-2)).replace(/M(?!a|ä|e)/, l.toString()).replace(/su/, Je(I(e))).replace(/D(?!e|é|i)/, ie(e, s.days));
}, Pe = (e) => e === null || e instanceof Date || typeof e == "string" || typeof e == "number", R = (e) => typeof e == "string" ? new Date(e) : e, ze = q({
  name: "DateInput",
  components: {
    IconView: je
  },
...
function Xe(e, t, s, o, l, m) {
  ...
  return g(), b("div", {
    ...
    Y(e.$slots, "belowDate", {}, void 0, !0)
  ], 2);
}
const Ze = /* @__PURE__ */ G(ze, [["render", Xe], ["__scopeId", "data-v-09a6219c"]]), _e = q({
  name: "PickerDay",
  props: {
    showDayView: {
      type: Boolean
  ...
  setup(e, { emit: t }) {
    ...
    function M() {
      ...
      if (!a || !a.from)
        return !1;
      const i = e.pageDate;
      return p(a.from) <= p(i) && f(a.from) <= f(i);
    }
    function F() {
      M() || m(1);
    }
    ...
    function J(a) {
      const i = e.highlighted;
      return i ? C(a) && i.from instanceof Date && f(i.from) === f(a) && p(i.from) === p(a) && I(i.from) === I(a) : !1;
    }
    function P(a) {
      const i = e.highlighted;
      return i ? C(a) && i.to instanceof Date && f(i.to) === f(a) && p(i.to) === p(a) && I(i.to) === I(a) : !1;
    }
    const A = y(() => {
      if (e.mondayFirst) {
      ...
      const a = e.pageDate, i = [], c = e.useUtc ? new Date(Date.UTC(a.getUTCFullYear(), a.getUTCMonth(), 1)) : new Date(a.getFullYear(), a.getMonth(), 1, a.getHours(), a.getMinutes()), L = Ie(f(c), p(c));
      for (let X = 0; X < L; X += 1)
        i.push({
          date: I(c),
          timestamp: c.getTime(),
...
function nt(e, t, s, o, l, m) {
  return le((g(), b("div", {
    ...
    Y(e.$slots, "customCalendarHeader"),
...
const st = /* @__PURE__ */ G(_e, [["render", nt]]), ot = q({
  ...
  setup(e, { emit: t }) {
    ...
    function F(r) {
      ...
      return D && f(D) === f(r) && p(D) === p(r);
    }
    function V(r) {
      let D = !1;
      const w = e.disabledDates;
      return !w || typeof w > "u" ? !1 : (typeof w.to < "u" && w.to && (p(r) < p(w.to) && f(r) <= f(w.to) || f(r) < f(w.to)) && (D = !0), typeof w.from < "u" && w.from && (p(r) > p(w.from) && f(r) >= f(w.from) || f(r) > f(w.from)) && (D = !0), typeof w.customPredictor == "function" && w.customPredictor(r) && (D = !0), D);
    }
    const k = y(() => {
    ...
    }), C = y(() => e.isRtl ? n() : l()), H = y(() => e.isRtl ? l() : n()), J = y(() => {
      const r = e.translation && e.translation.months;
      return ne(p(e.pageDate), r);
    }), P = y(() => {
...
const wt = /* @__PURE__ */ G(mt, [["render", bt]]), pt = () => {
  const e = "العربية";
  return {
    months: [
      "كانون الثاني",
  ...
  setup(e, { emit: t }) {
    ...
    const m = U(!1), n = U(!1), u = U(!1), M = U(0), F = U(/* @__PURE__ */ new Date()), V = y(() => e.initialView ? e.initialView : e.minimumView), k = y(() => new Date(o.value)), T = y(() => zt[e.language]), C = y(() => !!e.inline), H = y(() => ({
      position: C.value ? "static" : void 0
    })), J = y(() => m.value || n.value || u.value), P = y(() => T.value && T.value.rtl === !0);
    function A(h) {
    ...
    function d() {
      return j("day") ? (O(), m.value = !0, !0) : !1;
    }
    function r() {
      return j("month") ? (O(), n.value = !0, !0) : !1;
    }
    function D() {
      return j("year") ? (O(), u.value = !0, !0) : !1;
    }
    function w() {
      const h = V.value;
      if (!j(h))
    ...
    function E() {
      return e.disabled || C.value ? !1 : J.value ? O(!0) : (w(), !0);
    }
    function K(h) {
      const B = new Date(h);
    ...
    function a(h) {
      ...
      j("day") ? (A(B), d()) : Q(h), t("changed-month", h);
    }
    function i(h) {
      const B = new Date(h.timestamp);
      j("month") ? (A(B), r()) : Q(h), t("changed-year", h);
    }
    function c(h) {
      let B = h;
...
const Lt = /* @__PURE__ */ G(Rt, [["render", Ut]]);
export {
  Lt as default
};
